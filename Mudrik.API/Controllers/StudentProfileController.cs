...
namespace Mudrik.API.Controllers
{
    ...
    public class StudentProfileController : ControllerBase
    {
        ...
        public async Task<ActionResult> Add([FromBody] AddStudentProfileRequest request)
        {
            ...
            //var command = new AddStudentProfileCommand(addStudntDto);
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult> DeleteStudentProfile(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> UpdateStudentProfile(int id, [FromBody] UpdateStudentProfileRequest request)
        {
